...
def print_usage():
    ...
    console('    buildtimes - After the build, print per-package load/configure/build bars; on MSVC also a')
    console('                 vcperf frontend/backend/link breakdown (add a <target> to scope it)')
    console('  examples:')
