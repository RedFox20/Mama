...
class LocalSource(DependencySource):
    """
    ...
    def __str__(self):  return f'pkg {self.name} {self.rel_path} {self.mamafile} always_build={self.always_build}'
    def __repr__(self): return self.__str__()

    @staticmethod
    def from_papa_string(s: str) -> "LocalSource":
        p = s.split(',')
        name, rel_path, mamafile, always_build = p
        args = p[4:]
