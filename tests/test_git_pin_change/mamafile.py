...
class test(mama.BuildTarget):
    ...
    def dependencies(self):
        ...
        if stage == '0':
            self.add_git(remote_name, remote_url, git_tag='4acd9052f27a459314651dd485ae8fa79a04d49d') # has no REMOTE_VERSION
        if stage == '1':
            self.add_git(remote_name, remote_url, git_tag='993e326cf840bc2df9d67b14d6e2fe0d38736713') # has REMOTE_VERSION 2
        elif stage == '2':
