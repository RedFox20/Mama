...
# The two shapes the binutils search writes. A seeded configure skips that search, so each entry it
# drops reaches the build empty: the module scan runs "", and a project reading CMAKE_AR gets nothing.
